 ...
 if (!result) {
    ...
    const createBlotterText = () => {
      ...
      const render = () => {
        ...
        for (let i = 0; i <= imgsTotal - 1; ++i) {
          imgTranslations[i].x = MathUtils.lerp(imgTranslations[i].x, MathUtils.lineEq(20, -20, winsize.width, 0, relmousepos.x), i === imgsTotal - 1 ? 0.5 : 0.03 * i + 0.03);
          imgTranslations[i].y = MathUtils.lerp(imgTranslations[i].y, MathUtils.lineEq(20, -20, winsize.height, 0, relmousepos.y), i === imgsTotal - 1 ? 0.5 : 0.03 * i + 0.03);
  ...
  parcelRequire = (function(modules, cache, entry, globalName) {
    ...
    "FBzC": [function(require, module, exports) {
      "use strict";
